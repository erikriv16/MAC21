...
class CASHSALE:
    ...
    def toggleNewLabel(self):
        if not self.escapePress:
            if self.newLabel1 is None:
                ...
                self.newEntry1 = Entry(self.frame3, fg="white", bg=BLUE, font=("Arial", 25), bd=0, highlightthickness=0, insertbackground="white")
                ...
                self.newEntry1.config(textvariable=self.descpEntryVar)
                self.newEntry1.bind("<Return>", lambda event: self.handleSearchBySkew(self.descpEntryVar.get(), "transcMenu"))
    ...
    def enterOnQty(self, qtyEntry):
        ...
        extCostLabel.grid(row=1, column=5, sticky="nswe")
    ...
    def displayNotFoundErrorMessageSC2(self):
        ...
        notfoundLabel = Label(self.newFrame, fg="white", bg=BLUE, text="INVALID SKU-Press C to continue: [", font=("Arial", 25))
    ...
    def frame45Config(self):
        ...
        self.frame4 = Frame(frame45Super, bg="red")
        self.frame5 = Frame(frame45Super, bg="green")
